...
namespace AuthenticationService.Messaging
{
    public class Subscriber : ISubscriber
    {
        ...
        public Subscriber(IConnectionProvider connectionProvider, string exchange, string queue, string routingKey, string exchangeType, int timeToLive = 30000, ushort prefetchSize = 10)
        {
            ...
            _model.QueueDeclare(_queue, durable: true, exclusive: false, autoDelete: false, arguments: null);
        ...
        public void Subscribe(Func<BasicDeliverEventArgs, bool> callback)
        {
            ...
            consumer.Received += (sender, e) =>
            {
                ...
                bool success = callback.Invoke(e);
                if (success)
                {
